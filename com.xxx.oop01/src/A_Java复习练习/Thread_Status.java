...
/**
 * 线程的状态：
 *   新建--> NEW，RUNNABLE-->可运行状态, BLOCKED-->阻塞状态,
 *   WAITING--->无限等待状态, TIMED_WAITING-->计时等待,TERMINATED-->终止
 *
 * */
...
public class Thread_Status {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //获取start()之前的状态
        System.out.println("1.通过new初始化一个线程，但是还没有start()之前，线程的状态：" + th.getState());
        //启动线程
        th.start();
        //休眠50毫秒
        Thread.sleep(50);
        //因为thread1需要休眠100毫秒，所以在第50毫秒，thread处于sleep状态
        System.out.println("3.执行Thread.sleep(long)时，线程的状态：" + th.getState());
        //thread1和main线程主动休眠150毫秒，所以在第150毫秒,thread早已执行完毕
        Thread.sleep(100);
        System.out.println("5.线程执行完毕之后，线程的状态：" + th.getState() + "\n");
